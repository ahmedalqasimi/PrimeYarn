 ...
 * This file demonstrates how to integrate Primeyarn with a web frontend
 */

// For React/Vue/Angular applications
export class PrimeyarnClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new PrimeyarnClient(provider, contractAddress);
